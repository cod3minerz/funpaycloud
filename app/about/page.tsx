    ...
    >
      ...
      <section>
        ...
        <p>
          ...
          ключевые бизнес-процессы: автовыдачу товаров, обработку заказов и общение
          с покупателями с помощью ИИ-ассистента.
        </p>
        <p>
          Сервис работает 24/7 в облаке без необходимости держать включённый компьютер. Передача данных
          осуществляется по защищённому соединению, а чувствительные технические ключи и секреты хранятся

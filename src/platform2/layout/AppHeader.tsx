...
const AppHeader: React.FC = () => {
  ...
  return (
    <header
      ref={menuRef}
      className="sticky top-0 w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b"
    >
      <div className="flex flex-col lg:flex-row lg:px-6">
        {/* ── First row: always visible at h-16 ── */}
        <div className="h-16 flex items-center justify-between w-full gap-2 px-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0">
          <button

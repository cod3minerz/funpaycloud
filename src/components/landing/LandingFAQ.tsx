...
const faq = [
  ...
  },
  {
    ...
    answer:
      'Приоритетная поддержка в Telegram @fpcloud_support с временем ответа до 15 минут в рабочее время. На тарифе Ultra — персональная поддержка и приоритетные тикеты 24/7.',
  },
  {

...
const faq = [
  ...
  },
  {
    ...
    answer:
      'AI на базе GPT-4o понимает контекст диалога, отвечает клиентам как живой человек, обрабатывает типовые вопросы и возражения. Сложные случаи передаёт тебе. Ты задаёшь тон и шаблоны, AI подстраивается.',
  },
  {

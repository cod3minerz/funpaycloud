...
const faq = [
  ...
  },
  {
    ...
    answer:
      'Нет. Онбординг занимает 10 минут, мы ведём за руку на каждом шаге. Если что-то непонятно — команда поддержки @funpay_cloud поможет настроить всё за тебя в рамках бесплатного онбординга.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Приоритетная поддержка в Telegram @funpay_cloud с временем ответа до 15 минут в рабочее время. На тарифе Ultra — персональная поддержка @funpay_cloud и приоритетные тикеты 24/7.',
  },
  {
        ...
        <div className="faq-wrap">
          <div>
            ...
            <div className="faq-foot">
              Не нашёл ответа? <a href="https://t.me/funpay_cloud" target="_blank" rel="noreferrer">Напиши @funpay_cloud →</a>
            </div>
          </div>

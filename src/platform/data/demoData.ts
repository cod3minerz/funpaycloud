...
export const lots: Lot[] = [
  { id: 'lot1', accountId: 'acc1', title: 'Minecraft Java Edition ключ', category: 'Игры', categoryIcon: 'game', price: 450, status: 'active', salesMonth: 23, description: 'Лицензионный ключ Minecraft Java Edition', autoDelivery: 'KEY-{random}' },
  { id: 'lot2', accountId: 'acc1', title: 'Steam Wallet 500₽', category: 'Игры', categoryIcon: 'game', price: 520, status: 'active', salesMonth: 18, description: 'Пополнение кошелька Steam на 500 рублей', autoDelivery: '' },
  { id: 'lot3', accountId: 'acc1', title: 'Roblox 1000 Robux', category: 'Игры', categoryIcon: 'game', price: 350, status: 'active', salesMonth: 31, description: '1000 Robux для игры Roblox', autoDelivery: '' },
  { id: 'lot4', accountId: 'acc1', title: 'CS2 Prime аккаунт', category: 'Игры', categoryIcon: 'game', price: 780, status: 'inactive', salesMonth: 5, description: 'Аккаунт CS2 с Prime статусом', autoDelivery: '' },
  { id: 'lot5', accountId: 'acc2', title: '1000 подписчиков Instagram', category: 'SMM', categoryIcon: 'smm', price: 890, status: 'active', salesMonth: 45, description: '1000 живых подписчиков Instagram', autoDelivery: '' },
...
export const automationRules: AutomationRule[] = [
  ...
  },
  {
    ...
    actionText: 'Внимание! Остаток товара заканчивается.',
  },
  {
    id: 'rule4',
